...
public class ResultObject {
    ...
    public IList<InnerResultObject> Results { get; set; } = new List<InnerResultObject>() { new() };
    public IList<InnerResultObject> Results2 { get; set; } = new List<InnerResultObject>() { new() };
}
